...
for i in range(0, k):
    ...
    plt.scatter(res_x,res_y, 1, label='Trajektoria ruchu krążka')
    
    if len(X_Y)>5: 
        plt.scatter(x, y, color='orange', label='Położenie końcowe krążka')
    else: 
        plt.scatter(x, y, color='green', label='Położenie końcowe krążka przed out')
